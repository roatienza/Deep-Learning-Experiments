...
### Sample codes have links to other repo that I maintain ([Advanced Deep Learning with Keras](https://github.com/PacktPublishing/Advanced-Deep-Learning-with-Keras) book) or contribute ([Keras](https://github.com/keras-team/keras))
## Lecture Notes
0. Course Roadmap
...
- Utils for Testing Sentence Similarity
  - [BLEU](https://github.com/roatienza/Deep-Learning-Experiments/blob/master/utils/bleu_similarity.py)
  - [Spacy](https://github.com/roatienza/Deep-Learning-Experiments/blob/master/utils/spacy_similarity.py)
...
- Keras Sample Codes
  - [Q-Learning](https://github.com/PacktPublishing/Advanced-Deep-Learning-with-Keras/blob/master/chapter9-drl/q-learning-9.1.1.py)
  - [Q-Learning on FrozenLake-v0](https://github.com/PacktPublishing/Advanced-Deep-Learning-with-Keras/blob/master/chapter9-drl/q-frozenlake-9.2.1.py)
  - [DQN and DDQN on CartPole-v0](https://github.com/PacktPublishing/Advanced-Deep-Learning-with-Keras/blob/master/chapter9-drl/dqn-cartpole-9.3.1.py)
